...
const LoginBox = (props) => {
    ...
    const validate = () =>{
        const result = true;
        if(values.username === '' || values.username === null || values.password === '' || values.password === null){
            result = false;
        ...
        <div className={styles.LoginBox}>
            ...
            <div>
                ...
                <div className={styles.button_container}>
                    <button className={styles.ButtonStyle2} type="button">
                        <Link to='/venuehome' class='link-active' onClick={() => handleLogin}></Link>Log In</button>
                    <button className={styles.ButtonStyle1} type='button' onClick={() => navigator('/signup')}>Sign Up</button>
