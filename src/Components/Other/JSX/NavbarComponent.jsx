...
/*
    NavbarComponent is the top navigation bar on every page. Upon logging it, it loads all available Links for either the
    user or venue.
*/
export default function NavbarComponent () {
    ...
    return (
        <div className={styles.navbar}>
            <span id={styles.section_1} className='item_10'>
            ...
            <span id={styles.section_2} className='item_90'>
                {loggedIn && userType==='user' ?
                    (<>
                    <text className={styles.text}>{user.name}</text>
                    <img src={user.pfp ? user.pfp : ShowGoLogo} alt="pfp"/>
